...
import my from '../assets/image/query1.jpeg';
    ...
    return(
        <header>        <div style={{
            ...
            <ThemeProvider theme={theme}>
                <Button variant='contained' color='secondary' sx={{ ml: 3 }}><Link to='/' className='colors' style={{textDecoration:'none'}}>Send Request</Link></Button>
            </ThemeProvider> 
            <div style={{
                marginRight: '500px',
                position:'relative',
